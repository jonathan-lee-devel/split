...
for project in 'packages/split-auth' 'packages/split-constants' 'packages/split-observability' 'services/split-micro-users' 'services/split-micro-properties' 'services/split-micro-expenses'
do
